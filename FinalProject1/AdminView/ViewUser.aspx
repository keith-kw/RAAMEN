<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewUser.aspx.cs" Inherits="FinalProject1.AdminView.ViewUser" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>Customer List</h1>
        <div>
            <asp:GridView ID="MemberGv" runat="server"></asp:GridView>
            <br />
            <br />
        </div>
        <h1>Staff List</h1>
